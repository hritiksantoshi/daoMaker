            ...
            <div className="Header___StyledDiv-euryjq-0 eTEUIa">
              <div className="Header___StyledDiv2-euryjq-1 cyZZaq">
                <div className="Header___StyledDiv3-euryjq-2 hyGpzQ">
                  <h1 className="Header___StyledH-euryjq-4 ejqTJG">Finance</h1>
                </div>
                <div className="Header___StyledDiv4-euryjq-3 eIkgfQ">
                  <button
                    type="button"
                    onClick={handleShow1}
                    className="Button___StyledButtonBase-sc-8npd5h-0 iSFgBd ButtonBase___StyledButton-ur1q76-0 gUstKF"
                  >
                    New transfer
                  </button>
                </div>
                ...
                <div>
                  <div className="Balances___StyledDiv-sc-1bmtpxn-0 hsBXyI">
                    <div className="Balances___StyledDiv2-sc-1bmtpxn-1 heqIAM">
                      <ul className="efLiHx">
                        <li>
                          <div title="ETH" className="iABmVj">
                            <img
                              alt=""
                              width="20"
                              height="20"
                ...
                <div>
                  <div className="DataView___StyledDiv-sc-49otbs-0 dGpXSv">
                    <div className="Transfers___StyledDiv-sc-13g5zdb-1 fmDerI">
                      <div className="Transfers___StyledDiv2-sc-13g5zdb-2 jPojiV">
                        Transfers
                      </div>
                      <div>
                        <button
                          type="button"
                          className="Button___StyledButtonBase-sc-8npd5h-0 iYGvy ButtonBase___StyledButton-ur1q76-0 deWYNw"
                        >
                          <span className="Button___StyledSpan-sc-8npd5h-1 hTqOXo">
                            <svg
                              width="24"
                              height="24"
                              fill="none"
                    ...
                    <div className="TransfersFilters___StyledDiv-sc-pby1bs-0 ffJsvW">
                      ...
                      >
                        <button
                          type="button"
                          className="DropDown___StyledButtonBase-sc-17zpefi-0 vJVQb ButtonBase___StyledButton-ur1q76-0 deWYNw"
                        >
                          <div className="DropDown___StyledDiv-sc-17zpefi-1 fGExKQ">
                            Type
                          </div>
                          <IoIosArrowDropdown />
                        </button>
                      ...
                      <div className="DropDown___StyledDiv2-sc-17zpefi-3 ieczDL">
                        <div className="DropDown___StyledDiv3-sc-17zpefi-4 gCddCd">
                          <div className="DropDown___StyledDiv4-sc-17zpefi-5 daNBdV">
                            Type
                          </div>
                          <ul className="DropDown___StyledUl-sc-17zpefi-6 eIKyho">
                            <li>
                              <button
                                type="button"
                                className="DropDown___StyledButtonBase2-sc-17zpefi-7 eThEDw ButtonBase___StyledButton-ur1q76-0 biZGrf"
                              >
                                All
                              </button>
                            </li>
                            ...
                            <li>
                              <button
                                type="button"
                                className="DropDown___StyledButtonBase2-sc-17zpefi-7 kGlLQN ButtonBase___StyledButton-ur1q76-0 biZGrf"
                              >
                                Outgoing
                              </button>
                            </li>
                      ...
                      <div>
                        <button
                          type="button"
                          className="ButtonBase___StyledButton-ur1q76-0 gUstKE"
                        >
                          <div className="Labels___StyledDiv-sc-1is9uv6-0 cDKqzW">
                            <div className="Labels___StyledDiv2-sc-1is9uv6-1 fByhUr">
                              <div className="Labels___StyledDiv3-sc-1is9uv6-2 eaNajg">
                                Start day
                              </div>
                              <div className="Labels___StyledDiv4-sc-1is9uv6-3 kxCTxZ">
                                |
                              </div>
                              <div className="Labels___StyledDiv5-sc-1is9uv6-4 fHVlOr">
                                End day
                              </div>
                            </div>
                            <div className="Labels___StyledDiv6-sc-1is9uv6-5 cxrmQc">
                              <svg
                                ...
                                viewBox="0 0 24 24"
                                _css10="#8FA4B5"
                                className="Labels___StyledIconCalendar-sc-1is9uv6-6 bRBnEW"
                              >
                                <path
                                  fill="currentColor"
                                  fillRule="evenodd"
                  ...
                  <table className="TableView___StyledTable-aczwu3-0 dJrdkK">
                    <thead>
                      <tr>
                        <th
                          colSpan="1"
                          className="TableView___StyledTh-aczwu3-1 bNMroJ"
                        >
                          Date
                        </th>
                        <th
                          colSpan="1"
                          className="TableView___StyledTh-aczwu3-1 dXlcUR"
                        >
                          Source/recipient
                        </th>
                        <th
                        ...
                        <th
                          colSpan="1"
                          className="TableView___StyledTh-aczwu3-1 bBaFMQ"
                        >
                          Amount
                        </th>
                        <th
                          colSpan="1"
                          className="TableView___StyledTh-aczwu3-1 dskhUK"
                        ></th>
                      </tr>
                    </thead>
                    <tbody>
